...
public class Car {
    ...
    public Car(Long id, String name, int age, CarModel carModel, double carEngine, int yearOfProduction,
               int driverExperience, Taxi isTaxi) {
        Id = id;
        this.name = name;
        this.age = age;
    ...
    public Car(String name, int age, CarModel carModel, double carEngine, int yearOfProduction, int driverExperience,
               Taxi isTaxi, Result result, int insurancePayment) {
        this.name = name;
        this.age = age;
        this.carModel = carModel;
        this.carEngine = carEngine;
    ...
    public Car(String name, int age, CarModel carModel, double carEngine, int yearOfProduction,
               int driverExperience, Taxi isTaxi) {
        this.name = name;
        this.age = age;
        this.carModel = carModel;
