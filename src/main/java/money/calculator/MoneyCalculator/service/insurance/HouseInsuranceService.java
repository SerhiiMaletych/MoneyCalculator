...
public class HouseInsuranceService {
    ...
    public double findInsurancePayment(House house) {
        int basePayment = 500;
    ...
    public double findYearOfConstructionMultiplier(House house) {
        if ( house.getYearOfConstruction() < 1800 || house.getYearOfConstruction()>2021) {
    ...
    public double findHouseAreaMultiplier(House house) {
    ...
    public void checkCredentials(House house) {
        if (house.getName().isEmpty() || house.getName().isBlank() || house.getYearOfConstruction() < 1800 ||
                house.getYearOfConstruction() > 2021 || house.getHouseArea() <= 0 || house.getHouseArea() > 2000 ||
